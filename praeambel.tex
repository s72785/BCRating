\documentclass[german,12pt,paper=a4,DIV=calc,twoside, openright]{scrreprt%scrartcl%
}
%~ parskip=,%
%~ headsepline,
...
\hypersetup{%
	...
	colorlinks=false,
	hidelinks,
	%~ pdfborderstyle={/S/U/W 1},% for non-PDF/A
	%~ colorlinks,
	%draft,%no links
	%~ allcolors=black,%for PDF/A with pdfx
}
\usepackage[top=2cm,bottom=25mm,left=25mm,right=25mm]{geometry}
% minitoc
%~ \usepackage{minitoc}
