...
Dieser wurde mit \emph{Quorum} -- einem Fork einer Ethereum-Implementierung -- umgesetzt. Dies scheint also ein beachtenswerter Vergleichskandidat zu sein% der durch J.P.~Morgan finanziert wird.
.
%
...
Bisher ist BigchainDB nicht zuverlässig dezentral einsetzbar und bietet keine \gls{BFT}.
